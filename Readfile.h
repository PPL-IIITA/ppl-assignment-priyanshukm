...
class Readfile {
    ...
    public:
		vector <Boy> b; /* Store Data of all boys read from File */
		vector <Girl> g; /*Store Data of all girls read from File */
		vector <Gift> gi; /* Store Data of all gifts read from File */
